...
import 'package:radio_app/src/core/di/di_module.dart' as _i14;
...
import 'package:radio_app/src/presentation/navigators/radio_browser_navigator.dart'
    as _i8;
import 'package:radio_app/src/presentation/radio/bloc/radio_bloc.dart' as _i10;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factoryParam<_i10.RadioBloc, String, dynamic>((
      url,
      _,
    ) =>
        _i10.RadioBloc(
    ...
    gh.factory<_i11.RadioBrowserRepository>(
        () => _i11.RadioBrowserRepository(gh<_i7.RadioBrowserApi>()));
    gh.factory<_i12.GetRadioStationsByCountryCode>(() =>
        _i12.GetRadioStationsByCountryCode(gh<_i11.RadioBrowserRepository>()));
    gh.factory<_i13.RadioBrowserBloc>(
        () => _i13.RadioBrowserBloc(gh<_i12.GetRadioStationsByCountryCode>()));
    return this;
  }
}

class _$RadioPlayerProvider extends _i14.RadioPlayerProvider {}

class _$DioProvider extends _i14.DioProvider {}

class _$LoggerProvider extends _i14.LoggerProvider {}
